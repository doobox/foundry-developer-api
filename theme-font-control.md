...
Disabling an included face in the Theme Editor does not rewrite components. If a selected style or weight disappears entirely, the control offers the remaining family choices so authors can recover.
