...
<h1>Date</h1>
<p class="lede">A native date picker storing an ISO-8601 date String.</p>
...
The value initially stored for this control. Supply a valid ISO-8601 date string. A control array needs one value for each member.

Single control

```xml
<key>default</key>
<string>2026-08-30T00:00:00Z</string>
```
...
`{{ control.published }}` resolves as **HTML-escaped String**. Stored internally, its value is **String**.
...
<array>
    <dict>
        ...
        <key>default</key><string>2026-08-30T00:00:00Z</string>
