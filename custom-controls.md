...
<p class="lede">Each dictionary in <code>controls</code> creates part of the component Inspector. Declare what the author can change, then read the resulting value from HTML, CSS, JavaScript, or PHP.</p>
...
<a class="card" href="theme-font-control.html"><strong>themeFont</strong><p>A configurable font family, weight and style control.</p></a>
</div>
