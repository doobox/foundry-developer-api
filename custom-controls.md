...
<p class="lede">Each dictionary in <code>controls</code> creates part of the block Inspector. Declare what the author can change, then read the resulting value from HTML, CSS, JavaScript, or PHP.</p>
