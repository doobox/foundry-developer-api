...
For a Page destination, the Anchor menu lists valid anchors entered on block roots through the Advanced Inspector. Descendant IDs belonging to a block’s implementation are not shown.
